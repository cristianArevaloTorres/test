...
BEGIN TRY
    ...
    /* Insertar ocultos solamente los campos solicitados que aun no existan. */
    ;WITH Faltantes AS
    (
    ...
    */
    ...
    /* Si algo no queda exactamente oculto, revertir todo el lote. */
    IF EXISTS
    (
        SELECT 1
        FROM @TargetResuelto AS R
...
/* Resultado final: todas estas filas deben mostrar visible=0. */
