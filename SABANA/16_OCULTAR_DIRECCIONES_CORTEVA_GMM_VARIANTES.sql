...
/*
La ejecucion diagnosticada de CORTEVA carga:
  idEmpresaParam = 332
  grupo           = GMM
  columnaGrupo    = NombrePestana

GMM Garantizado, GMM Optimo, GMM Plus y GMM Premium no son grupos de
configuracion independientes: son valores de NombrePestana. Al registrar
estas siete columnas como no visibles en el grupo GMM, el API las reconoce
como configuradas y no las vuelve a anexar como columnas dinamicas.
*/
...
BEGIN TRY
    ...
    /* Insertar como ocultas las direcciones que no estaban en las 34
       columnas efectivas de CORTEVA. Se toma el formato de otra
    ...
    (
        ...
        THROW 50403,'No quedaron ocultas las siete direcciones de CORTEVA GMM.',1;
